 ...
 * Deze versie maakt gebruik van binnenklassen voor de luisteraars.
...
public class EventVoorbeeld extends JFrame {
  ...
  public void initialize() {
    ...
    // Creeer luisteraar en voeg deze toe aan de label
    // en de knop
  ...
  /**
   * Luisteraar als binnenklasse.
   * Hierbij is gebruik gemaakt van de MouseAdapter.
   */
  public class EnterExitLuisteraar extends MouseAdapter {

    /**
     * Event handler voor het binnegaan van de muiswijzer
     * in een component
     * Maakt de achtergrond van de bron turkoois.
     */  
    public void mouseEntered(MouseEvent e) {
