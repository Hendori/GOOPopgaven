...
public class CDCollectieFrame extends JFrame {
  ...
  private JList<String> trackLijst = null;
  ...
  private void trackKnopAction() {
    ...
    try {
      ...
      if (tracks != null) {
        DefaultListModel<String> model = (DefaultListModel<String>) trackLijst.getModel();
        model.removeAllElements();
   ...
   * @return javax.swing.JList
   */
  private JList<String> getTrackLijst() {
    if (trackLijst == null) {
  ...
  public static void main(String[] args) {
    SwingUtilities.invokeLater(new Runnable() {
      public void run() {
        CDCollectieFrame gui = new CDCollectieFrame();
        gui.setVisible(true);
