...
public class Vlucht {
   ...
   */
  private ArrayList<Integer> reserveringen = new ArrayList<>();
  ...
  /**
   * Creeer een vlucht en start een aantal kantoren, elk in een 
   * eigen thread. Alle kantoren roepen dezelfde methode boek aab
   * op de vlucht.
   */
