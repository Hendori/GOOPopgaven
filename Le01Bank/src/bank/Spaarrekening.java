...
/**
 * Klasse Spaarrekening beheert het saldo van een rekeninghouder volgens de
 * regels van spaarrekeningen.
 * Een spaarrekening geeft rente, maar kent wel beperkende voorwaarden.
 * Bij een spaarrekening hoort een tegenrekening.
 * Er kan geen geld van een spaarrekening worden overgemaakt worden naar een andere rekening.
...
public class Spaarrekening extends Rekening {
  ...
  /**
   * Maakt een spaarrekening met gegeven rekeninghouder, rekeningnummer en tegenrekening.
   ...
   */
  public Spaarrekening(Rekeninghouder rekeninghouder, int nummer, Betaalrekening rekening) {
   ...
   * Opname van een spaarrekening betekent storten van het bedrag op de tegenrekening.
